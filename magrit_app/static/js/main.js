...
<span class="i18n" style="z-index: 2;display: inline-block; margin-bottom: 20px;" data-i18n="[html]app_page.common.long_computation"></span><br>`;
  ...
  const_options.append('button')
    ...
    .html('<img src="static/img/header/File_font_awesome_orange.png" width="25" height="auto" alt="Load project file"/>')
    .on('click', () => {
  ...
  const_options.append('button')
    ...
    .styles({ cursor: 'pointer', background: 'transparent', 'margin-top': '5px' })
    .html('<img src="static/img/header/Folder_open_alt_font_awesome_orange.png" width="25" height="auto" alt="Load project file"/>')
  ...
  const_options.append('button')
    ...
    .html('<img src="static/img/header/Breezeicons-actions-22-document-save-orange.png" width="25" height="auto" alt="Save project to disk"/>')
  ...
  const_options.append('button')
    ...
    .styles({ cursor: 'pointer', background: 'transparent', 'margin-top': '5px' })
    .html('<img src="static/img/header/Documents_icon_-_noun_project_5020_orange.png" width="20" height="auto" alt="Documentation"/>')
    .on('click', () => {
  ...
  const_options.append('button')
    ...
    .html('<img src="static/img/header/High-contrast-help-browser_orange.png" width="20" height="20" alt="export_load_preferences" style="margin-bottom:3px;"/>')
    .on('click', () => {
...
function change_projection(new_proj_name) {
  ...
  if (!layer_name && def_proj.bounds) {
    ...
    layer_name = layers_active.length > 0
      ? _app.id_to_layer.get(layers_active[layers_active.length - 1].id)
      : undefined;
  }
  if (layer_name) {

...
if __name__ == "__main__":
    ...
    import timeit
    import time
    setup = '''from __main__ import get_grid_layer; f = "/home/mz/dev/noname-stuff/noname_app/static/data_sample/nuts3_data.geojson"'''
    ...
    for i in range(n):
        t = time.time()
        result1 = get_grid_layer("/home/mz/dev/noname-stuff/noname_app/static/data_sample/nuts3_data.geojson", 115000, "pop1999", "square")
    ...
    for i in range(n):
        t = time.time()
        result2 = get_grid_layer("/home/mz/dev/noname-stuff/noname_app/static/data_sample/nuts3_data.geojson", 115000, "pop1999", "square2")

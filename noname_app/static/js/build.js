...
require("../../noname_app/static/js/colors_helpers");
require("../../noname_app/static/js/discretization_panel");
require("../../noname_app/static/js/discrtiz_links_discont");
require("../../noname_app/static/js/function");
var _interface = require("../../noname_app/static/js/interface");
require("../../noname_app/static/js/join_popup");
require("../../noname_app/static/js/layers_style_popup");
require("../../noname_app/static/js/layout_features");
require("../../noname_app/static/js/legend");
require("../../noname_app/static/js/map_project");
...
function setUpInterface() {
    ...
    bg.innerHTML = '<p style="color: white; z-index: 2;text-align:center;margin-top:185px;">' + i18next.t('app_page.common.loading_results') + ' ...</p><div class="load-wrapp" style="left: calc(50% - 60px);position: absolute;top: 50px;"><div class="load-1"><div class="line"></div><div class="line"></div><div class="line"></div></div></div>';
    ...
    window.section1 = accordion1.append("div").attr("id", "section1").attr("class", "i18n").attr("data-i18n", "[data-tooltip]app_page.tooltips.section1");
    ...
    accordion3.append("div").attrs({ id: "section3", class: "i18n", "data-i18n": "[data-tooltip]app_page.tooltips.section3" }), accordion4.append("div").attr("id", "section4");
    accordion5.append("div").attr("id", "section5");

    var dv1 = section1.append("div"),
        dv11 = dv1.append("div").style("width", "auto");

    dv11.append("img").attrs({ "id": "img_in_geom", "class": "user_panel", "src": "/static/img/b/addgeom.png", "width": "26", "height": "26", "alt": "Geometry layer" }).style("cursor", "pointer").on('click', _interface.click_button_add_layer);

    dv11.append("p").attrs({ id: "input_geom", class: "user_panel i18n" }).styles({ display: "inline", cursor: "pointer", "margin-left": "5px", "vertical-align": "super", "font-weight": "bold" }).attr("data-i18n", "[html]app_page.section1.add_geom").on('click', _interface.click_button_add_layer);

    var dv12 = dv1.append("div");
    dv12.append("img").attrs({ "id": "img_data_ext", "class": "user_panel", "src": "/static/img/b/addtabular.png", "width": "26", "height": "26", "alt": "Additional dataset" }).style("cursor", "pointer").on('click', _interface.click_button_add_layer);

    dv12.append("p").attrs({ "id": "data_ext", "class": "user_panel i18n" }).styles({ display: "inline", cursor: "pointer", "margin-left": "5px", "vertical-align": "super", "font-weight": "bold" }).attr("data-i18n", "[html]app_page.section1.add_ext_dataset").on('click', _interface.click_button_add_layer);
    ...
    dv1.append("p").attr("id", "browse_section").attr("align", "center").html("").append("button").attrs({ id: "browse_button", class: "button_st3 i18n", disabled: true }).style("font-size", "12px").attr("data-i18n", "[html]app_page.section1.explore_table").on("click", function () {
        boxExplore.create();
    });

    make_ico_choice();

    section2.append("p").style("font-size", "18px").attr("class", "i18n").attr("data-i18n", "[html]app_page.section2.no_func");
    ...
    dv3.append("img").attr("src", "/static/img/b/addgeom_t.png").styles({ cursor: "pointer", margin: "2.5px", float: "right", "border-radius": "10%" }).on("click", _interface.click_button_add_layer);
    ...
    var a = dv4.append("li").styles({ margin: "1px", padding: "4px" });
    a.append("p").attr("class", "list_elem_section4 i18n").attr("data-i18n", "[html]app_page.section4.map_width");
    a.append("input").attr("class", "list_elem_section4").styles({ position: "absolute", right: "20px" }).style("width", "80px").style("margin-left", "15px").attrs({ id: "input-width", type: "number", value: w }).on("change", function () {
        canvas_mod_size([this.value, null]);
    });

    var b = dv4.append("li").styles({ margin: "1px", padding: "4px" });
    b.append("p").attr("class", "list_elem_section4 i18n").attr("data-i18n", "[html]app_page.section4.map_height");
    b.append("input").attr("class", "list_elem_section4").styles({ position: "absolute", right: "20px" }).style("width", "80px").style("margin-left", "15px").attrs({ id: "input-height", type: "number", "value": h }).on("change", function () {
    ...
    c.insert("span").attr("id", "map_center_menu_ico").attr("class", "ui-accordion-header-icon ui-icon ui-icon-triangle-1-e").style("display", "inline-table");
    c.on("click", function () {
        var sections = document.querySelectorAll(".to_hide"),
            arg = void 0;
        ...
        var ico_menu = document.getElementById("map_center_menu_ico");
    });
    var c1 = dv4.append("li").styles({ margin: "1px", padding: "4px", display: "none" }).attr("class", "to_hide");
    c1.append("p").attr("class", "list_elem_section4 i18n").attr("data-i18n", "[html]app_page.section4.map_center_x");
    c1.append("input").styles({ position: "absolute", right: "20px" }).style("width", "80px").style("margin-left", "15px").attrs({ id: "input-center-x", type: "number", "value": round_value(zoom_prop.x, 2), step: "any" }).on("change", function () {
        svg_map.__zoom.x = +this.value;
        zoom_without_redraw();
    });

    var c2 = dv4.append("li").styles({ margin: "1px", padding: "4px", display: "none" }).attr("class", "to_hide");
    c2.append("p").attr("class", "list_elem_section4 i18n").attr("data-i18n", "[html]app_page.section4.map_center_y");

    c2.append("input").attr("class", "list_elem_section4").attrs({ id: "input-center-y", type: "number", "value": round_value(zoom_prop.y, 2), step: "any" }).styles({ position: "absolute", right: "20px" }).style("width", "80px").style("margin-left", "15px");

    var d = dv4.append("li").styles({ margin: "1px", padding: "4px", display: "none" }).attr("class", "to_hide");
    d.append("p").attr("class", "list_elem_section4 i18n").attr("data-i18n", "[html]app_page.section4.map_scale_k");
    d.append("input").attr("class", "list_elem_section4").styles({ position: "absolute", right: "20px" }).style("width", "80px").style("margin-left", "15px").attrs({ id: "input-scale-k",
        type: "number",
    ...
    var e = dv4.append("li").styles({ margin: "1px", padding: "4px" });
    e.append("p").attr("class", "list_elem_section4 i18n").attr("data-i18n", "[html]app_page.section4.map_title");
    e.append("input").attr("class", "list_elem_section4").attr("id", "title").styles({ "margin": "0px 0px 0px 3px" }).on("keyup", function () {
        handle_title(this.value);
    });
    e.insert("span").styles({ display: "inline", top: "4px", cursor: "pointer", "vertical-align": "sub" }).html(sys_run_button.replace("submit", "Title properties")).on("click", handle_title_properties);
    ...
    f.append("p").attr("class", "list_elem_section4").insert("input").styles({ "vertical-align": "middle", "margin-left": "15px" }).attrs({ type: "color", id: "bg_color", value: "#ffffff" }).on("change", function () {
    ...
    g.append("input").attr("type", "range").attr("id", "form_rotate").attr("value", 0).attr("min", 0).attr("max", 360).attr("step", 1).styles({ width: "80px", "margin": "9px 10px 9px 15px", "vertical-align": "middle" }).on("input", function () {
        rotate_global(this.value);
        document.getElementById("canvas_rotation_value_txt").value = this.value;
    });

    g.append("input").attr("class", "without_spinner").attr("id", "canvas_rotation_value_txt").attrs({ value: 0, min: 0, max: 360, step: "any" }).styles({ width: "30px", "margin-left": "10px" }).on("change", function () {
        rotate_global(this.value);
    ...
    var _h = dv4.append("li");
    _h.append("p").attr("id", "btn_add_layout_ft").style("cursor", "pointer").html("<b>" + i18next.t("app_page.section4.layout_features") + "</b> " + sys_run_button).on("click", select_layout_features);

    var section5 = d3.select("#section5");
    var dv5 = section5.append("p").style("text-align", "center").attr("class", "form-item");

    dv5.insert('label-item').attr("class", "i18n").attr("data-i18n", "[html]app_page.section5.projection");

    var rotation_param = section5.append("div").styles({ "text-align": "center", "width": "300px" });

    rotation_param.append("p").attrs({ id: "rotation_params", class: "i18n" }).attr("data-i18n", "[html]app_page.section5.projection_center_lambda");

    rotation_param.append("input").attrs({ type: "range", id: "form_projection_center", value: 0.0,
        min: -180.0, max: 180.0, step: 0.1 }).styles({ width: "160px", "vertical-align": "middle" }).on("input", function () {
    ...
    rotation_param.append("input").attrs({ type: "number", class: "without_spinner", id: "proj_center_value_txt",
        min: -180.0, max: 180.0, value: 0, step: "any" }).styles({ width: "38px", "margin-left": "10px" }).on("change", function () {
        handle_proj_center_button([this.value, null, null]);
        document.getElementById("form_projection_center").value = this.value;
    });

    rotation_param.append("span").html("°");

    section5.append("div").style("text-align", "center").insert("button").attr("id", "reset_center_rotation").attr("class", "button_st4 i18n").attr("data-i18n", "[html]app_page.section5.reset").on("click", function () {
    ...
    d3.json("/static/data_sample/simplified_land_polygons.topojson", function (error, json) {
        background.selectAll('.subunit').data(topojson.feature(json, json.objects.simplified_land_polygons).features).enter().append('path').attr("d", path).styles({ stroke: "rgb(0,0,0)", fill: "lightgrey", "stroke-opacity": 0.0, "fill-opacity": 0.75 });
    ...
    var p = dv5.append("select").attr("id", "form_projection").style("align", "center").on("change", function () {
    ...
    var const_options = d3.select(".header_options").append("div").attr("id", "const_options").style("display", "inline");

    const_options.append("button").attrs({ id: "current_app_lang", class: "const_buttons" }).styles({ color: "white", "font-size": "14px", background: "transparent", "font-weight": "bold" }).style("color", "white").style("font-size", "14px").html(i18next.language).on("click", function () {
        if (document.getElementById("menu_lang")) document.getElementById("menu_lang").remove();else {
            (function () {
                if (document.getElementById("menu_pref")) document.getElementById("menu_pref").remove();
    ...
    const_options.append("button").attrs({ class: "const_buttons", id: "export_btn",
        title: "Export / Load your map preferences" }).styles({ cursor: "pointer", background: "transparent", "margin-top": "none" }).html('<img src="/static/img/Wikiversity-Mooc-Icon-Download_modif_blank.png" width="20" height="20" alt="export_load_preferences"/>').on("click", function () {
        if (document.getElementById("menu_pref")) {
            ...
            (function () {
                ...
                var actions = [{ "name": i18next.t("app_page.export_box.svg"), "callback": export_compo_svg }, { "name": i18next.t("app_page.export_box.png"), "callback": export_compo_png }, { "name": i18next.t("app_page.common.save_project_json"), "callback": save_map_template }, { "name": i18next.t("app_page.common.load_project_json"), "callback": load_map_template }, { "name": i18next.t("app_page.export_box.geo"), "callback": make_export_layer_box }];
                var menu = document.createElement("div");
                menu.style.top = "30px";
    ...
    const_options.append("button").attrs({ id: "help_btn", class: "const_buttons", title: "help" }).styles({ cursor: "pointer", background: "transparent", "margin-top": "none" }).html('<img src="/static/img/High-contrast-help-browser_blank.png" width="20" height="20" alt="export_load_preferences"/>').on("click", function () {
        if (document.getElementById("menu_lang")) document.getElementById("menu_lang").remove();
        if (document.getElementById("menu_pref")) document.getElementById("menu_pref").remove();
        swal({
    ...
    var lm_buttons = [{ id: "zoom_out", title: i18next.t("app_page.lm_buttons.zoom-"), class: "zoom_button", html: "-" }, { id: "zoom_in", title: i18next.t("app_page.lm_buttons.zoom+"), class: "zoom_button", html: "+" }, { id: "info_button", title: i18next.t("app_page.lm_buttons.i"), class: "info_button", html: "i" }, { id: "hand_button", title: i18next.t("app_page.lm_buttons.hand_button"), class: "hand_button active", html: '<img src="/static/img/Closed_Hand_thenounproject_blank.png" width="18" height="18" alt="Hand_closed"/>' } /*,
    ...
    var selec = lm.selectAll("input").data(lm_buttons).enter().append('p').style("margin", "auto").insert("button").attr("class", function (d) {
        return d.class;
    ...
    $("#accordion2_pre").on("accordionbeforeactivate", function () {
        ...
        var section2_accordion = document.getElementById("accordion2").firstChild;
        if (section2_accordion.getAttribute("aria-expanded") == "true") section2_accordion.dispatchEvent(new Event("click"));
    });
    ...
    $(".accordion").on("accordionactivate", function (event, ui) {
        if (!ui.newPanel || ui.newPanel.length == 0) return;
        var last_opened = ui.newPanel[0].parentElement.id;
        var opened = [];
        var accordions = document.querySelectorAll(".accordion");
        var new_size = 33; // Use the real header size instead of 33
        for (var i = 0; i < accordions.length; i++) {
            new_size = new_size + accordions[i].getBoundingClientRect().height;
            if (accordions[i].firstChild.getAttribute("aria-expanded") == "true") opened.push(accordions[i].id);
        }
        opened.splice(opened.indexOf(last_opened), 1);
        if (new_size > window.innerHeight && opened.indexOf("accordion1") > -1 && last_opened != "accordion1") {
        ...
        for (var _i = opened.length - 1; _i > 0; --_i) {
            if (new_size < window.innerHeight) break;
            var acc = document.getElementById(opened[_i]);
            new_size = new_size - acc.getBoundingClientRect().height;
            $("#" + opened[_i]).accordion("option", "active", 1);
            opened.pop();
        }
    });
...
function make_ico_choice() {
    var list_fun_ico = ['icon_prop.png', 'icon_choro.png', 'icon_typo.png', 'icon_choroprop.png', 'icon_flow.png', 'icon_grid.png', 'icon_cartogram.png', 'icon_smooth.png', 'icon_discont.png', 'icon_typosymbol.png', 'icon_label.png'];
    var function_panel = section2_pre.append("p").style("text-align", "center").style("margin-top", "1px").style("margin-bottom", "1px");

    var _loop3 = function _loop3(i, len_i) {
        var ico_name = list_fun_ico[i],
            func_name = ico_name.split('.')[0].split("_")[1],
            func_desc = get_menu_option(func_name).desc;
        function_panel.append("img").attr("title", i18next.t(["app_page.func_description.", func_name].join(''))).attr("src", ["/static/img/func_icons/", ico_name].join('')).attr("id", "button_" + func_name).style("margin", "1px").style("cursor", "pointer").on("click", function () {
            ...
            var selec_title = document.getElementById("accordion2").querySelector("h3");
...
var button_result_type = new Map([["flow", '<img src="/static/img/type_geom/layer_flow.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["symbol", '<img src="/static/img/type_geom/layer_symbol.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["grid", '<img src="/static/img/type_geom/layer_grid.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["MTA", '<img src="/static/img/type_geom/layer_mta.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["propchoro", '<img src="/static/img/type_geom/layer_propchoro.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["typo", '<img src="/static/img/type_geom/layer_typo.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["discont", '<img src="/static/img/type_geom/layer_disc.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["cartogram", '<img src="/static/img/type_geom/layer_cartogram.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["label", '<img src="/static/img/type_geom/layer_label.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["choro", '<img src="/static/img/type_geom/layer_choro.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["smooth", '<img src="/static/img/type_geom/layer_smooth.svg" class="ico_type" width="17" height="17" alt="Polygon"/>'], ["prop", '<img src="/static/img/type_geom/layer_prop.svg" class="ico_type" width="17" height="17" alt="Polygon"/>']]);
...
function displayInfoOnMove() {
    ...
    if (info_features.classed("active")) {
        ...
        var _ret6 = function () {
            ...
            var id_top_layer = "#" + top_visible_layer,
    ...
    for (var lyr_name in current_layers) {
        if (current_layers[lyr_name].renderer && (current_layers[lyr_name].renderer.indexOf('PropSymbol') > -1 || current_layers[lyr_name].renderer.indexOf('TypoSymbols') > -1 || current_layers[lyr_name].renderer.indexOf('Label') > -1)) {
            (function () {
                ...
                map.select("#" + ref_layer_name).selectAll("path").each(function (d, i) {
                    new_coords.push(path.centroid(d));
                });

                if (symbol == "text") {
                    map.select("#" + lyr_name).selectAll(symbol).attr("x", function (d, i) {
                        return new_coords[i][0];
                    }).attr("y", function (d, i) {
                        return new_coords[i][1];
                    });
                } else if (symbol == "image") {
                    map.select("#" + lyr_name).selectAll(symbol).attr("x", function (d, i) {
                        console.log(this);return new_coords[i][0] - +this.getAttribute("width").slice(0, -2) / 2;
                    }).attr("y", function (d, i) {
                        return new_coords[i][1] - +this.getAttribute("width").slice(0, -2) / 2;
                    });
                } else {
                    var ord = features_order.map(function (obj) {
                        return obj[0];
                    });
                    for (var i = 0; i < ord.length; i++) {
                        features_order[i][2] = new_coords[ord[i]];
                    }if (symbol == "circle") map.select("#" + lyr_name).selectAll(symbol).attr("cx", function (d, i) {
                        return features_order[i][2][0];
                    }).attr("cy", function (d, i) {
                        return features_order[i][2][1];
                    }).attr("r", function (d, i) {
                        return features_order[i][1];
                    });else if (symbol == "rect") map.select("#" + lyr_name).selectAll(symbol).attr("x", function (d, i) {
                        return features_order[i][2][0] - features_order[i][1] / 2;
                    }).attr("y", function (d, i) {
                        return features_order[i][2][1] - features_order[i][1] / 2;
...
// which can be used like `myConfirmDialog(".classBox", "Title", {html_content: "..."}).then(function(confirmed){if(confirmed){ ... }})
var make_confirm_dialog = function make_confirm_dialog(class_box, title, options) {
    ...
    $("#dialog").dialog({
        position: options.top ? { my: "center", at: "top" } : undefined,
        width: options.width, height: options.height, modal: true,
        buttons: [{
            text: text_ok,
            click: function click() {
                deferred.resolve(true);$(this).dialog("close");
            }
        }, {
            text: text_cancel,
            click: function click() {
...
function remove_layer_cleanup(name) {
    ...
    if (current_layers[name].targeted) {
        ...
        d3.select("#input_geom").html(i18next.t("app_page.section1.add_geom")).on('click', click_button_add_layer);
        ...
        if (joined_dataset.length == 0) document.getElementById("browse_button").disabled = true;
    }
...
function redraw_legends_symbols(targeted_node) {
    ...
    for (var i = 0; i < legend_nodes.length; ++i) {
        var layer_name = legend_nodes[i].classList[2].split('lgdf_')[1],
        ...
        var new_lgd = document.querySelector(["#legend_root2.lgdf_", layer_name].join(''));
...
function rotate_global(angle) {
    ...
    if (northArrow.displayed) {
        var current_transform = northArrow.svg_node.attr("transform");
        if (current_transform) northArrow.svg_node.attr("transform", ["rotate(", angle, ",", northArrow.x, ",", northArrow.y, "),"].join('') + current_transform);else northArrow.svg_node.attr("transform", ["rotate(", angle, ",", northArrow.x, ",", northArrow.y, ")"].join(''));
    }
};
...
function handleClipPathLayer(layer_name) {
    var _proj_name = current_proj_name.toLowerCase();
    if (_proj_name.indexOf("interrupted") > -1 || _proj_name.indexOf("armadillo") > -1 || _proj_name.indexOf("healpix") > -1) {
        map.select("#" + layer_name).attr("clip-path", "url(#clip)");
    }
}
...
function handle_title(txt) {
    ...
    if (title.node()) {
        ...
        map.append("g").attr("class", "legend legend_feature title").insert("text").attrs({ id: "map_title", x: "50%", y: "8%",
            "alignment-baseline": "middle", "text-anchor": "middle" }).styles({ "font-family": "Arial, Helvetica, sans-serif",
            "font-size": "20px", position: "absolute", color: "black" }).text(txt);
    }
}
...
function handle_title_properties() {
    var title = d3.select("#map_title");
    if (!title.node()) {
        swal("", i18next.t("app_page.common.error_no_title"), "error");
        return;
    }
    var title_props = {
    ...
    make_confirm_dialog("mapTitleitleDialogBox", i18next.t("app_page.title_box.title"), { width: 280 }).then(function (confirmed) {
    ...
    box_content.append("p").html(i18next.t("app_page.title_box.xpos")).insert("input").attrs({ type: "number", min: 0, max: 100, step: 1, value: +title_props.position_x.split("%")[0] }).style("width", "50px").on("change", function () {
        title.attr("x", this.value + "%");
    });
    box_content.append("p").html(i18next.t("app_page.title_box.ypos")).insert("input").attrs({ type: "number", min: 0, max: 100, step: 1, value: +title_props.position_y.split("%")[0] }).style("width", "50px").on("change", function () {
        title.attr("y", this.value + "%");
    });
    box_content.append("p").html(i18next.t("app_page.title_box.font_color")).insert("input").attrs({ type: "color", value: title_props.color }).on("change", function () {
...
function patchSvgForFonts() {
    function getListUsedFonts() {
        var elems = [svg_map.querySelectorAll('text'), svg_map.querySelectorAll('p')];
...
function make_export_layer_box() {
    d3.select("body").append("div").attrs({ id: "dialogGeoExport", class: "exportGeoDialogBox",
        title: i18next.t("app_page.export_box.geo_title_box") }).style("font-size", "0.6em").html("");

    var dialogBox = $("#dialogGeoExport"),
    ...
    var selec_projection = box_content.append("p").html(i18next.t("app_page.export_box.option_projection")).insert("select").attr("id", "projection_to_use");
    ...
    box_content.append("p").append("button").attr("class", "button_st4").html("Export").on("click", function () {
        ...
        $.ajax({
            ...
            success: function success(data, code, obj) {
...
},{"../../noname_app/static/js/colors_helpers":2,"../../noname_app/static/js/discretization_panel":3,"../../noname_app/static/js/discrtiz_links_discont":4,"../../noname_app/static/js/function":5,"../../noname_app/static/js/interface":6,"../../noname_app/static/js/join_popup":7,"../../noname_app/static/js/layers_style_popup":8,"../../noname_app/static/js/layout_features":9,"../../noname_app/static/js/legend":10,"../../noname_app/static/js/map_project":11}],2:[function(require,module,exports){
"use strict";
...
var display_discretization = function display_discretization(layer_name, field_name, nb_class, type, options) {
    ...
    var make_sequ_button = function make_sequ_button() {
        ...
        var sequential_color_select = col_div.insert("p").attr("class", "color_txt").html("Color palette ").insert("select").attr("class", "color_params").on("change", function () {
            redisplay.draw();
        });
    ...
    var make_diverg_button = function make_diverg_button() {
        ...
        col_div.selectAll('.color_txt2').remove();
        col_div.selectAll('#reverse_pal_btn').remove();
        col_div.insert('p').attr("class", "central_class").html("Break on ").insert("input").attrs({
    ...
    var available_functions = [[i18next.t("app_page.common.equal_interval"), "equal_interval"], [i18next.t("app_page.common.quantiles"), "quantiles"], [i18next.t("app_page.common.std_dev"), "std_dev"], [i18next.t("app_page.common.Q6"), "Q6"], [i18next.t("app_page.common.arithmetic_progression"), "arithmetic_progression"], [i18next.t("app_page.common.jenks"), "jenks"]];
    ...
    user_defined_breaks.insert("button").text("Valid").on("click", function () {
        var old_nb_class = nb_class;
...
exports.click_button_add_layer = click_button_add_layer;
exports.handle_upload_files = handle_upload_files;
exports.prepare_drop_section = prepare_drop_section;
exports.convert_dataset = convert_dataset;
exports.handle_shapefile = handle_shapefile;
exports.handle_TopoJSON_files = handle_TopoJSON_files;
exports.handle_reload_TopoJSON = handle_reload_TopoJSON;
exports.handle_dataset = handle_dataset;
exports.add_dataset = add_dataset;
exports.add_csv_geom = add_csv_geom;
exports.handle_single_file = handle_single_file;
exports.add_layer_topojson = add_layer_topojson;
exports.scale_to_lyr = scale_to_lyr;
exports.center_map = center_map;
exports.select_layout_features = select_layout_features;
...
var MAX_INPUT_SIZE = exports.MAX_INPUT_SIZE = 8704000; // max allowed input size in bytes
...
function add_layer_topojson(text, options) {
    ...
    var _loop = function _loop(i) {
        random_color1 = ColorsSelected.random();
    ...
    for (var i = 0; i < layers_names.length; i++) {
        var random_color1, lyr_name, lyr_name_to_add;
...
function select_layout_features() {
    var available_features = [["north_arrow", i18next.t("app_page.layout_features_box.north_arrow")], ["scale", i18next.t("app_page.layout_features_box.scale")], ["sphere", i18next.t("app_page.layout_features_box.sphere")], ["graticule", i18next.t("app_page.layout_features_box.graticule")], ["text_annot", i18next.t("app_page.layout_features_box.text_annot")], ["arrow", i18next.t("app_page.layout_features_box.arrow")], ["symbol", i18next.t("app_page.layout_features_box.symbol")]];
    var selected_ft;
...
var UserArrow = function () {
    ...
    _createClass(UserArrow, [{
        ...
        value: function up_element() {
            var lgd_features = this.parent.querySelectorAll(".legend"),
        ...
        value: function editStyle() {
            ...
            s2.append("button").attr("class", "button_st4").html(i18next.t("app_page.arrow_edit_box.move_points")).on("click", function () {
...
var Textbox = function () {
    ...
    _createClass(Textbox, [{
        ...
        key: "up_element",
        value: function up_element() {
            var lgd_features = document.querySelectorAll(".legend"),
                nb_lgd_features = lgd_features.length,
                self_position = void 0;
            for (var i = 0; i < nb_lgd_features; i++) {
                if (lgd_features[i].id == this.id) {
...
var scaleBar = {
    create: function create() {
        ...
        var getItems = function getItems() {
            return [{ "name": "Edit style and size...", "action": function action() {
                    _this4.editStyle();
                } }, { "name": "Delete", "action": function action() {
                    _this4.remove();
                } }];
    ...
    getDist: function getDist() {
        ...
        var dist = haversine_dist(pt1, pt2);
    ...
    resize: function resize(desired_dist) {
        ...
        var ratio = +this.dist_txt / desired_dist;
...
var northArrow = {
    display: function display() {
        ...
        var getItems = function getItems() {
            return [{ "name": "Options...", "action": function action() {
                    _this5.editStyle();
                } }, { "name": "Delete", "action": function action() {
                    _this5.remove();
                } }];
        ...
        var arrow_svg = arrow_gp.append("g");
        arrow_svg.append("polygon").attrs({ fill: "none", stroke: "#000000", "stroke-miterlimit": 10,
            points: "62.3,77.9 78.9,68.5 78.9,46.4 " });
        arrow_svg.append("polygon").attrs({ stroke: "#000000", "stroke-miterlimit": 10,
            points: "79.9,46.4 79.9,68.5 96.7,77.8 " });
        arrow_svg.insert("path").attr("d", "M72.8,28.6h2.9l6.7,10.3v-10.3h3v15.7h-2.9l-6.7-10.3v10.3h-3V78.6z");

        var bbox = document.getElementById("north_arrow").getBoundingClientRect(),
            xy0_map = get_map_xy0();

        this.under_rect = arrow_gp.append("g").insert("rect").style("fill", "green").style("fill-opacity", 0).attr("x", bbox.x - xy0_map.x).attr("y", bbox.y - xy0_map.y).attr("height", bbox.height).attr("width", bbox.width);
    ...
    editStyle: function editStyle() {
        ...
        box_body.append("input").attrs({ type: "range", min: 0, max: 2, step: 0.1 }).attr("value", !isNaN(+self.svg_node.attr("scale")) ? +self.svg_node.attr("scale") : 1).on("change", function () {
            var scale_val = +this.value;
            var translate_param = self.svg_node.attr("transform"),
                rotate_value = self.svg_node.attr("rotate");
            rotate_value = rotate_value ? "rotate(" + [rotate_value, self.x_center, self.y_center] + ")" : "";
            var translate_values = translate_param ? /\(([^\)]+)\)/.exec(translate_param)[1].split(',').map(function (d) {
                return +d;
            }) : [0, 0];
            var t_x = translate_values[0] - self.x_center * (scale_val - 1),
        ...
        box_body.append("input").attrs({ type: "range", min: 0, max: 360, step: 0.1 }).attr("value", !isNaN(+self.svg_node.attr("rotate")) ? +self.svg_node.attr("rotate") : 0).on("change", function () {
            var translate_param = self.svg_node.attr("transform"),
                scale_value = self.svg_node.attr("scale");
            scale_value = scale_value ? "scale(" + scale_value + ")" : "";
            translate_param = translate_param && translate_param.indexOf("translate") > -1 ? "translate(" + translate_param.split("translate(")[1].split(')')[0] + ")" : "";
...
function createlegendEditBox(legend_id, layer_name) {
    ...
    rectangle_options.insert("input").attrs({ type: "checkbox",
        ...
        if (this.checked) {
            rectangle_options.select("#choice_color_under_rect").attr("value", "#ffffff").attr("disabled", null);

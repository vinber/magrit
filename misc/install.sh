#!/bin/sh
sudo apt-get -y install libgdal-dev libproj-dev libv8-dev libffi-dev libpython3.5-dev python3.5 r-base redis-server nodejs npm libfftw3-dev libzmq-dev python3.5-numpy python3.5-gdal
